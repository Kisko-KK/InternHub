...
const LandingPage = () => {
  ...
  <div className="d-flex justify-content-between w-50 mt-5">
    <Button variant="primary" className="custom-button" onClick={handleStudentRegistry}>
      Registry as a student
    </Button>
    <Button variant="primary" className="custom-button" onClick={handleCompanyRegistry}>
      Registry as a company
    </Button>
  </div>
  <Button variant="primary" className="custom-button mt-5" onClick={handleLogin}>
    Login
  </Button>
</div>
